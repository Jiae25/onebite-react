...
페이징 라우팅, 글로벌 레이아웃 설정, 공통 컴포넌트 구현, 개별 페이지 및 복잡한 기능 구현

## 이번 시간에 구현할 공통 컴포넌트

Button, Header 컴포넌트 구현
...
투두리스트 프로젝트 = 감정 일기장 프로젝트

"투두" , "일기" 라는 형태의 데이터를 관리하는 프로그램
...
# ch10. Home 페이지 구현하기 1. UI

여러개의 일기를 리스트로 렌더링하는 "Home" 페이지
